...
@registry.register("infer_method", "spider_beam_search_with_heuristic")
...
@registry.register("infer_method", "spider_beam_search_with_orable_column")
...
@registry.register("infer_method", "spider_beam_search_with_orable_sketch")
