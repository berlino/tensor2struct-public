...
class BiLSTM(torch.jit.ScriptModule):
    """
    BilSTM and UniLSTM are originally in the same object. However, if the option
    bidirectional is false, torch would still need the reverse function to be compiled;
    this is why I created another UniLSTM object to address this.
    """
    def __init__(
        self,
        input_size,
...
class UniLSTM(torch.jit.ScriptModule):
    def __init__(
        self,
        input_size,
        hidden_size,
